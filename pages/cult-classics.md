...
Customers like [Forrest Ellsworth]({{ '/items/mainstreet024.html' | relative_url }}) would capitalize on the store’s five-movie rental deal to expand his knowledge of film and explore the catalog. In addition to three movies chosen intentionally, he would pick one that he had heard about, and one random selection. This is how he discovered some of his favorite movies, including [*Come and See*  (1985)](https://www.criterion.com/films/28895-come-and-see){:target='_blank' rel='noopener'}, [*McCabe & Mrs. Miller* (1971)](https://www.criterion.com/films/28712-mccabe-mrs-miller){:target='_blank' rel='noopener'}, and [*Magnolia* (1999)](https://www.youtube.com/watch?v=KnamcFv_N9Q){:target='_blank' rel='noopener'}. For an especially transcendent experience, watch that last one with {% include feature/youtube-clip-modal.html text="Chicken McNuggets" objectid="mainstreet024" %}.

The collection was also a way for customers to learn about different cinematic traditions across time and place. For [Lily Pannkuk]({{ '/items/mainstreet015.html' | relative_url }}), the foreign film section offered a chance to explore the affective differences between German and French films. Her teen obsession with [Fritz Lang](https://www.criterion.com/search#stq=fritz+lang){:target='_blank' rel='noopener'} gave her insight into the transition from silent films to talkies. 
...
For a taste, check out [*Werewolves on Wheels* (1971)](https://www.youtube.com/watch?v=YQDDGbSJN0o){:target='_blank' rel='noopener'}{% include feature/marginnote-image.html img="https://upload.wikimedia.org/wikipedia/en/7/73/Werewolvesonwheels.jpg" caption="_Werewolves on Wheels_" %} and [*Vampiyaz: Brothaz in Blood* (2004)](https://vimeo.com/504606578){:target='_blank' rel='noopener'}{% include feature/marginnote-image.html img="/objects/vampiyaz.jpg" caption="_Vampiyaz: Brothaz in Blood_" link="https://www.lib.uidaho.edu/digital/mainstreet/objects/vampiyaz.jpg" %}.
...
[Scarecrow Video](https://scarecrowvideo.org/){:target='_blank' rel='noopener'} in Seattle has {% include feature/youtube-clip-modal.html text="a treasure trove of rare media" objectid="mainstreet008" start="1008" %}, including two VHS copies of [*Eraserhead* (1977)](https://www.criterion.com/films/28382-eraserhead){:target='_blank' rel='noopener'} and Disney’s racist *Song of the South* (1946) [which Disney has tried](https://www.theguardian.com/film/2019/nov/19/song-of-the-south-the-difficult-legacy-of-disneys-most-shocking-movie){:target='_blank' rel='noopener'} to [hide from American audiences](https://www.syfy.com/syfy-wire/how-disney-tried-and-failed-to-remove-song-of-the-south-from-history){:target='_blank' rel='noopener'} despite profiting from it elsewhere. 
...
That being said, tape _would_ deteriorate if played repeatedly, as one group of girls learned after watching some pivotal scenes from [*Dirty Dancing*](https://www.youtube.com/watch?v=eIcmQNy9FsM){:target='_blank' rel='noopener'} a few too many times...
...
Reportedly, {% include feature/youtube-clip-modal.html text="dusting was often left off the list" objectid="mainstreet014" start="3653" %}.
...
Many of the employees were inspired by [Quentin Tarantino](https://www.vulture.com/2015/08/best-quentin-tarantino-movies-ranked.html ){:target='_blank' rel='noopener'} who famously worked at a video store before finding success in the movie industry.[Connor O’Rourke]({{ '/items/mainstreet031.html' | relative_url }}) grew up dreaming about someday working at a video store, imagining it as "the perfect job."
...
When customer [Bekah Miller MacPhee]({{ '/items/mainstreet004.html' | relative_url }}) saw a movie she loved as an employee pick, “I’d think, {% include feature/youtube-clip-modal.html text="Oh my gosh, I have a kinship with this person" objectid="mainstreet004" start="697" %},"(though generally things didn’t go as far as in [that one *Seinfeld* episode](https://www.youtube.com/watch?v=cDwJSX8suEQ){:target='_blank' rel='noopener'}.)
