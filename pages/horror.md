...
{% include feature/youtube-clip-modal.html text='"I was more likely to watch a whole movie from Howard Hughes because of the extra effort,"' objectid="mainstreet028" start="702" %} says [Martin McGreevy]({{ '/items/mainstreet028.html' | relative_url }}).
